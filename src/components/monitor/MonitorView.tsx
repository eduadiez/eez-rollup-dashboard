...
export const MonitorView: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const tryAutoConnect = () => {
      ...
      const l2ManagerAddr = config.ccmL2Address || "0x4200000000000000000000000000000000000007";
      ...
      setL2ContractAddress(l2ManagerAddr);

      // Seed architecture graph
      const result = initManagerNodes(rollupsAddr, l2ManagerAddr);
