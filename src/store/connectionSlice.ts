...
export const createConnectionSlice: StateCreator<ConnectionSlice> = (set) => ({
  l1RpcUrl: config.l1Rpc,
  l2RpcUrl: config.l2Rpc,
  l1ContractAddress: config.rollupsAddress,
  l2ContractAddress: config.ccmL2Address || "0x4200000000000000000000000000000000000007",
  connected: false,
  l1Connected: false,
  l2Connected: false,
