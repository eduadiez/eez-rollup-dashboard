...
/** Selector for EEZ.createCrossChainProxy(address,uint64) */
const CREATE_PROXY_SELECTOR = "a7587c62";

/** Selector for EEZ.computeCrossChainProxyAddress(address,uint64) */
const COMPUTE_PROXY_SELECTOR = "eb20c0aa";
